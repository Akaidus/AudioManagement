...
namespace AudioManagement
{
    ...
    public class AudioPlayer : MonoBehaviour
    {
        ...
        public void PlaySound()
        {
            ...
            // We pass in the enum value from the AudioData to reference the sound effect we want to play.
            // This can either be done by passing in the enum value directly (SoundEffect.Boom), or by passing in the AudioData and accessing the enum value from it like we do here.
            ...
            AudioManager.Play(audioData.enumValue, targetTransform, followTarget);
        }
        ...
        public void PlayLooping()
        {
            ...
            audioSource = AudioManager.PlayLooping(audioData.enumValue, targetTransform, followTarget);
        ...
        public void PlayFadeIn(float fadeTime)
        {
            ...
            // The sound will start at volume 0 and fade in to the volume specified in the AudioData for the sound effect over the specified fadeTime variable.
            AudioManager.PlayFadeIn(audioData.enumValue, fadeTime, targetTransform, followTarget);
        }
        ...
        public void PlayFadeOut(float fadeTime)
        {
            ...
            // The sound will start at the volume specified in the AudioData for the sound effect and fade out to volume 0 over the specified fadeTime variable.
            AudioManager.PlayFadeOut(audioData.enumValue, fadeTime, targetTransform, followTarget);
        }
        ...
        public void PlayRandomPitchAndVolume()
        {
            ...
            AudioManager.PlayRandomPitchAndVolume(audioData.enumValue, pitchRange, volumeRange, targetTransform, followTarget);
        }
